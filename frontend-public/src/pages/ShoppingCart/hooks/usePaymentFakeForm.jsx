...
const usePaymentFakeForm = () => {
  ...
  const handleFakePayment = async () => {
    try {
      ...
      const tokenResponse = await fetch("https://rose-candle-copruebavr-1.onrender.com/api/payments/token", {
        method: "POST",
        credentials: "include",
        headers: {
      ...
      const paymentResponse = await fetch("https://rose-candle-copruebavr-1.onrender.com/api/payments/testPayment", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
