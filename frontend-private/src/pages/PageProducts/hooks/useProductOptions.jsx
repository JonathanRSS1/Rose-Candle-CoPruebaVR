    ...
    const fetchOptions = async () => {
      try {
        ...
        const resCategories = await fetch(
          "https://rose-candle-copruebavr-1.onrender.com/api/productcategories"
        );
        ...
        const resCollections = await fetch(
          "https://rose-candle-copruebavr-1.onrender.com/api/collections"
        );
        ...
        const resMaterials = await fetch(
          "https://rose-candle-copruebavr-1.onrender.com/api/rawMaterials"
        );
